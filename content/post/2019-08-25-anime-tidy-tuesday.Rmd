...
date: '2019-08-25'
slug: tt-19-17-anime
featured: "norway_pano.jpg"
featuredalt: "Norway panorama"
categories:
  - dataviz
tags:
  - tidytuesday
...
For a first blog post, I thought to jump into a great online community called [#TidyTuesday](https://thomasmock.netlify.com/post/tidytuesday-a-weekly-social-data-project-in-r/){target="_blank"} and add my own small contribution to the weekly event.
...
```{r echo = FALSE}
blogdown::shortcode("tweet", "1120670584881471488")
```
